...
public class ConsulGatewayStart {
    public static void main(String[] args) {
        ...
        SpringApplication.run(ConsulGatewayStart.class, args);
    }


    @GetMapping("/check")
    public String health() {
        return "consul check success!";
    }

    @GetMapping("/check1")
    public String health1() {
        return "consul check1 success!";
    }

    @GetMapping("/api/v1/check2")
    public String health2() {
        return "consul /api/v1/check2 success!";
    }

    @GetMapping("/check3")
    public String health3() {
        return "consul check3 success!";
    }
